...
- Built-in Migration (well if you dont know how Metasploit's process migration works,it injects the payload to other process and kill the first session,but it will be invisible on the UI.So i want to replicate that)
